...
public class ListObjects {
    ...
    public static void main(String[] args) {
        ...
        List<String> list = new ArrayList<String>(); // reference of the interface List but the object is Arraylist
        list.add("a");
        list.add("b");
        list.add("c");
        list.add("d");
        list.add(null); // null is allowed
        list.add("a"); // can add duplicates
        ...
        List<String> list2 = new LinkedList<>(); // reference of the interface List but the object is Linked List
        list2.add("a");
        list2.add("b");
        list2.add("c");
        list2.add("d");
        list2.add(null); // null is allowed
        list2.add("a"); // can add duplicates
        ...
        list3.add("a"); // can add duplicates
