...
//    }
    ...
    public static void draw (int num, String color2){
        System.out.println("Trying to draw with " + num +" brush and " + color2 + " color");
    }

    public static void draw (String color2, int num){
        System.out.println("Trying to draw with " + num +" brush and " + color2 + " color");
    }
