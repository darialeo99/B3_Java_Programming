...
public class UsingApp {
    public static void main(String[] args) {
        ...
        App app1 = new App();
        // app1 has its own version/ copies of name, version, is isFree

        App app2 = new App();
        // app2 has its own version/ copies of name, version, is isFree
        ...
        System.out.println(new App().name); // This a completely new object
