...
/*
    ...
    - constructor
        ...
        - create a constructor that creates a Pizza object with the size and the num of toppings
...
public class Pizza {
    ...
    public double calculatePrice() {
        // handing invalid conditions if a match small, medium,large not found
        if (size == null) {
            return -1;
        }
