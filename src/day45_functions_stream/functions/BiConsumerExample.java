...
public class BiConsumerExample {
    ...
    public static void main(String[] args) {
        ...
        // froEach with Collection -s accepting Consumer
        map.forEach( (K , V) -> {
            System.out.println(K + " " + V);

        });

        // Bi Consumer <? super K, ? super V> action ---> (K, V) -> {........});
        // map.forEach ---> will look though map, and get each KEY and VALUE each cycle and assign them into K and V
